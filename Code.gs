...
function doPost(e) {
  ...
  if (parsedData !== undefined){
    ...
    var value3 = dataArr [3]; // value0 from Arduino code - Branch
    var value4 = dataArr [4]; // value0 from Arduino code - Branch
    ...
    switch (parsedData.command) {
      ...
      case "insert_row":
         ...
         sheet.getRange('G2').setValue(value4);   // publish Phone Number from Arduino code to cell F2
